...
class SetupReportCommand:
    ...
    def execute(self):
        ...
        self.fp.write('/baseline { 14 } def\n')
        self.fp.write('/title { /TimesRomanLatin 14 selectfont } def\n')
        self.fp.write('/head { /TimesRomanLatin 11 selectfont } def\n')
        self.fp.write('/body { /TimesRomanLatin 11 selectfont } def\n')
        self.fp.write('/foot { /TimesRomanLatin 11 selectfont } def\n')
